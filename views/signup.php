...
<body>
    ...
    <div class="right-rec">
        ...
        <div class="centered">
            <form class="container py-4 col-form-label-lg" action="register.php" autocomplete="on" method="POST"><!--register.php selected and form uses Post method-->


                <div class="form-group-row">
                    <div class="form-group-column">
                        <h4>First Name</h4><!--textfield to set First name-->
                ...
                <div class="change-form">
                    <p id="" class="form-text text-muted">Already have an account? Log in <a href="signin.php">here</a><!--link to Log in-->
                    </p>
                </div>
                <br>
